...
<head>
  ...
  <link rel="icon" type="image/png" href="https://img.icons8.com/?size=160&id=108803&format=png">
  <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&display=swap" rel="stylesheet">
  <title>Login - Sistema de Gerenciamento de TV</title>
  <style>
    * {
      margin: 0;
      padding: 0;
    ...
    .input-group .toggle-password.visible {
      display: block;
    }
    ...
    .login-btn {
      width: 100%;
      padding: 14px;
      background: linear-gradient(45deg, #047857, #34D399);
      border: none;
      border-radius: 6px;
      color: #ffffff;
      font-size: 1.1rem;
...
<body>
  ...
  <div class="login-container">
    <h2>Sistema de Gerenciamento de TV</h2>
    <form id="loginForm">
  ...
  <script>
    // Updated particle animation for a more modern TV signal effect
    const canvas = document.querySelector('.tv-canvas');
    ...
    // Enhanced ripple effect on input focus
    ...
    passwordInput.addEventListener('input', function() {
      togglePassword.classList.toggle('visible', this.value.length > 0);
    });
